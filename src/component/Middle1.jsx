...
const Middle1 = () => {
  return (
    <div class="container px-4 middle ">
  <div class="row gx-5">
    <div class="col ">
     <div class="p-3"><button type="button" class="btn btn-#272727 text-white"><img src={Fill} alt="" />Do it for me.LLC</button></div>
     <div class="text-white fs-1 fw-bold ">The Next<span class="border-info text-info fw-light fs-6 get">GET Started<img src={Arrow}/></span></div>
